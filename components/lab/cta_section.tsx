				...
				{activeModal !== "none" && (
					...
					>
						<motion.div
							...
							className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-border/80 bg-card p-6 shadow-2xl"
									...
									<div className="space-y-3">
										<div className="space-y-1">
											...
											<input
												...
												className="w-full rounded-lg border border-input bg-background/50 px-3 py-2 text-sm text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-primary"
											/>
										</div>
										...
										<div className="space-y-1">
											...
											<textarea
												...
												className="w-full rounded-lg border border-input bg-background/50 px-3 py-2 text-sm text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none"
											/>
										</div>
									</div>

									<Button type="submit" disabled={isSubmitting} className="w-full bg-primary hover:bg-primary/95 text-primary-foreground font-semibold">
										{isSubmitting ? (
							...
							{activeModal === "support" && (
								<div className="space-y-5">
									...
									<div className="space-y-4">
										...
										<a
											href="https://buymeacoffee.com/mance"
											target="_blank"
											rel="noopener noreferrer"
											className="flex items-center justify-between rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 transition-all hover:bg-amber-500/15"
										>
											<div className="flex items-center gap-3">
												<div className="flex size-10 items-center justify-center rounded-full bg-amber-500 text-white font-bold">
													<Coffee className="size-5" />
												</div>
												<div className="text-left">
													<p className="text-sm font-semibold text-amber-200">Buy Me A Coffee</p>
													<p className="text-xs text-muted-foreground">Support via standard credit card</p>
												</div>
											</div>
										...
										<div className="rounded-xl border border-violet-500/20 bg-violet-500/5 p-4 space-y-2">
											<div className="flex items-center justify-between">
												...
												<button
													...
													className="rounded-lg border border-border bg-card p-1.5 hover:bg-muted text-muted-foreground hover:text-foreground transition-all"
												>
